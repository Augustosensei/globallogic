...
class UsuarioServiceImplTest {
    ...
    @Captor  ArgumentCaptor<Usuario> userCaptor;
    ...
    private UsuarioDTO buildDto() {
        ...
        tel.setNumber(123L); tel.setCitycode(54); tel.setContrycode("+54");
    ...
    private Usuario buildEntity() {
        ...
        u.setId(1L); u.setName("Denise"); u.setEmail("denise@example.com");
